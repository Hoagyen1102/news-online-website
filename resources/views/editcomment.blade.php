...
<div class="wrapper">
    ...
    <div class="comment">
        ...
        <div class="eachcomment">
            ...
            <div>
            <p>{{$cmt->Fullname}}</p>
            @if($cmt->_id != $editcmt->_id)
                <a>{{$cmt->Content}}</a>
            </div>
            @endif
            @if($cmt->_id == $editcmt->_id)
                <form action="/checkeditcomment" method="post">
                @csrf
                    <input type="hidden" name="id" value = "{{$editcmt->_id}}"/>
                    <input type="hidden" name="News_id" value = "{{$news->News_id}}"/>
                    <input type="text" name="editcmt" placeholder="&emsp;Nhập nội dung bình luận..." value="{{$editcmt->Content}}"/>
        ...
        @csrf
            <textarea name="comment" placeholder="&emsp;&emsp;Nhập bình luận ở đây"></textarea>
